...
import ErrorsReservation from "./ErrorsReservation";

// function FormReservation({ formData, setFormData, reservations, setReservations}){
function FormReservation(){
    ...
    function submitHandler(event){
        ...
        console.log("submitHandler validate error", reservationErrors);
    ...
    //     createReservation(abortController.signal)
    ...
    return (
        <form onSubmit={submitHandler}>
            <ErrorsReservation errors={error} />
